...
[![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg?style=for-the-badge)](https://www.gnu.org/licenses/gpl-3.0) [![Sponsors](https://img.shields.io/badge/Sponsors-BECOME%20A%20SPONSOR-ea4aaa?style=for-the-badge&logo=github-sponsors)](https://github.com/sponsors/10per5) [![Stars](https://img.shields.io/github/stars/10per5/inb4doc?style=for-the-badge&logo=github)](https://github.com/10per5/inb4doc/stargazers)
...
The writable data dir (`~/.local/share/inb4doc` / `%APPDATA%\inb4doc`) is created by the app on first run.
...
**Editor** — A local server with a WYSIWYG editor (Milkdown + ProseMirror) and raw markdown mode. Filesystem is the source of truth: directories map to the page tree, edits write directly to `.md` files. Run with `editor:dev`.

**SSG** — Runs Hugo with the Book theme to generate a static site. Deploy anywhere (GitHub Pages, Surge, Netlify, etc.). Generate with `predep hugo-fetch`.
